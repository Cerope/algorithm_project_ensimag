...
def print_components_sizes(distance, points):
    ...
    while points != []:
        ...
        flag = False
        flag2 = False #Utile pour eviter des fusions inutiles
        ...
        for composante in liste_comp_conn:
            for point in composante:
                if point_courant.distance_to(point) <= distance:
                    ...
                    if not flag:
                        composante.append(point_courant) # On la rattache
                        ...
                        flag2 = True # On va devoir faire une fusion
        ...
        elif flag2: #Sinon, fusion si flag2
            nv_composante = []
            for composante in composante_temp:
                nv_composante += composante
                liste_comp_conn.remove(composante)
            liste_comp_conn.append(nv_composante)
